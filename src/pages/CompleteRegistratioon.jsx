...
export default function CompleteRegistration() {
  ...
  const [done, setDone]       = useState(false);
   ...
   const tokenPrefilled = !!tokenFromUrl;
  ...
  async function handleSubmit(e) {
    ...
    const required = ['token', 'firstName', 'lastName', 'email', 'password', 'nin', 'adminKey'];
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Registration failed. Check your token and try again.');
    } finally {
      setLoading(false);
    }
  }
          ...
          {!done ? (
            <>
              ...
              <p className="text-sm text-gray-500 mb-6">
                {tokenPrefilled
                  ? 'Your invitation token has been pre-filled. Enter your personal details to finish setting up your account.'
                  : 'Enter the token from your invitation email along with your personal details.'
                }
              </p>
              ...
              {tokenPrefilled && (
                <div className="flex items-center gap-2 bg-green-50 text-green-700 text-sm px-4 py-3 rounded-lg mb-5">
                  ...
                  Invitation token received — fill in your details below
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                {/* Token field — shown but read-only if pre-filled from link */}
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                    Invitation token
                  </label>
                  ...
                  {tokenPrefilled && (
                    <p className="text-xs text-green-600">Token pre-filled from your invitation link</p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <i className="ti ti-user absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <i className="ti ti-shield-lock absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                    <input name="adminKey" type="text" value={form.adminKey} onChange={handleChange}
            ...
            <div className="text-center py-6">
              ...
              <Link to="/login"
                ...
                <i className="ti ti-login" /> Go to login
              </Link>
            </div>
          )}
        </div>
